...
if ( ! function_exists( 'avada_header_content_3' ) ) {
	function avada_header_content_3() {
		...
		echo '<div class="fusion-header-content-3-wrapper"><div id="content-3-search-box">' . $html . '</div><div id="header-medical-logos"><img id="aao" src="http://drcross.flywheelsites.com/wp-content/uploads/2016/01/american-academy-of-ophthalmology@2x.png" alt="American Academy of Ophtalmology Logo"><img src="http://drcross.flywheelsites.com/wp-content/uploads/2016/01/texas-medical-association@2x.png" alt="Texas Medical Association Logo"><img src="http://drcross.flywheelsites.com/wp-content/uploads/2016/01/Harris-County-Medical-Society@2x.png" alt="Harris County Medical Society Logo"></div></div>';
	}
}
